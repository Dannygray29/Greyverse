    ...
    <main className="shell">
      ...
      <section className="hero">
        ...
        <form onSubmit={submit} className="card form">
          <label>Username<input aria-label="Username" placeholder="Username" value={username} onChange={event => setUsername(event.target.value)} required minLength={3} /></label>
          ...
          <label>Email<input aria-label="Email" type="email" placeholder="Email" value={email} onChange={event => setEmail(event.target.value)} required /></label>
          <label>Password<input aria-label="Password" type="password" placeholder="Password (6+ characters)" minLength={6} value={password} onChange={event => setPassword(event.target.value)} required /></label>
